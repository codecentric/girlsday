...
/**
 * constants to manage task types at one place
 */
export class TaskType {
  static WASH_FACE = 'Gesicht waschen';
  static BRUSH_TEETH = 'Zähne putzen';
  ...
  static BREAKFAST = 'Frühstück';
  static DRIVE_TO_SCHOOL = 'Zur Schule fahren';
  static CLEAN_KITCHEN = 'Küche aufräumen';
  static DRINK_COFFEE = 'Kaffee trinken';
  static READ_NEWSPAPER = 'Zeitung lesen';
  static PREPARE_FOR_SCHOOL = 'Schulsachen packen';
}
